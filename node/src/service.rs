...
mod tests {
	...
	#[test]
	// It is "ignored", but the node-template ignored tests are running on the CI.
	// This can be run locally with `cargo test --release -p node-template test_sync -- --ignored`.
	#[ignore]
	fn test_sync() {
